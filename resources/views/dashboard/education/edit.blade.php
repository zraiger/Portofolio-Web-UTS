    ...
    <form action="{{ route('education.update',$data->id) }}" method="POST">
        ...
        <div class="mb-3">
            <div class="row">
                ...
                <div class="col-auto"><input type="date" class="form-control form-control-sm" name="tgl_str" placeholder="dd/mm/yyyy" value="{{ $data->tgl_str }}"></div>
                <div class="col-auto">End Date</div>
                <div class="col-auto"><input type="date" class="form-control form-control-sm" name="tgl_end" placeholder="dd/mm/yyyy"value="{{ $data->tgl_end }}"></div>
            </div>
        </div>
