...
class halamanController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success','Succesfully updated the data');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success','Succesfully deleting the data');
    }
}
